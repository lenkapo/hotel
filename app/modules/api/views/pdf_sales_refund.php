...
$pdf->SetAuthor('FHK');
$pdf->SetTitle('Sales Refund').$item->tsre_code;
$pdf->SetSubject('Sales Refund');
$pdf->SetKeywords('Sales Refund');
...
$html = '
<h3 align="center">SALES REFUND</h3>
<p>
<p/>
...
<table width="100%" border="0" cellpadding="2">
  <tr>
    <td width="100%" colspan="8" style="font-size:14px;">Nominal yang dikembalikan : <b> Rp.'.number_format($item->tsre_total_price,2,',','.').'</b></td>
  </tr>
<hr/>
  <tr>
  ...
  <tr>
    <td width="100%" bgcolor="#EFEFEF" colspan="8" style="font-size:14px;word-wrap: break-word;" align="center"><b>'.ucwords(terbilangs($item->tsre_total_price)).' Rupiah </b></td>
  </tr>
  <tr>
...
<h4 align="center">No Sales Return : '.$item_return->tsr_code.'</h4>
<p>
<p/>
<table width="100%" border="0" cellpadding="1">
  <tr>
  ...
  <tr>
    <td bgcolor="#ecf0f1">Nama : '.$item_return->tso_mcu_name.'</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="3" bgcolor="#ecf0f1">Invoice No : '.$item_return->tso_invoice.'</td>
    <td bgcolor="#ecf0f1">&nbsp;</td>
  </tr>
  <tr>
    <td bgcolor="#ecf0f1">Alamat : '.$item_return->mcu_address.'</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="3" bgcolor="#ecf0f1">Invoice Date : '.Date('d-F-Y',strtotime($item_return->tso_invoice_date)).'</td>
    <td bgcolor="#ecf0f1">&nbsp;</td>
  </tr>
  <tr>
    <td bgcolor="#ecf0f1">Phone : '.$item_return->mcu_mobile.'</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td width="15%">&nbsp;</td>
    <td width="10%">&nbsp;</td>
...
<table width="100%" border="0" cellpadding="2">
  <tr>
    ...
    <td width="6%"></td>
    <td width="14%" align="center"><b>'.$item_return->tsr_qty.'</b></td>
    <td width="5%">&nbsp;</td>
  </tr>
  <tr>
    <td bgcolor="#EFEFEF" style="word-wrap: break-word;">'.$item_return->tsr_note.'</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>Total Price Returned : </td>    
    <td width="6%">Rp. </td>
    <td width="14%" align="right"><b>'.number_format($item_return->tsr_total_price,2,',','.').'</b></td>
    <td width="5%">&nbsp;</td>
  </tr>
<hr/>
  <tr>
  ...
  <tr>
    <td width="100%" bgcolor="#EFEFEF" colspan="8" style="font-size:14px;word-wrap: break-word;" align="center">'.ucwords(terbilangs($item_return->tsr_total_price)).' Rupiah </td>
  </tr>
  <tr>
    <td width="100%" bgcolor="#EFEFEF" colspan="8" style="font-size:14px;"></td>
  </tr>
...
$pdf->Output('Invoice'.$item->tsre_code.'.pdf', 'I');
