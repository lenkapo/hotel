  <!-- banner section -->
  <section class="section-banner" style="background-image: url('<?= base_url('assets/data_img_hotel/' . (!empty($room->main_image) ? $room->main_image : 'default-banner.jpg')) ?>');">
                          ...
                          <div class="slider slider-for">
                              <?php foreach ($room->gallery as $img): ?>
                                  <div class="lh-room-details-image">
                                      <img src="<?= base_url('assets/data_img_hotel/' . $img->file_name) ?>"
                      ...
                      <div class="lh-side-reservation">
                          ...
                          <form action="<?= site_url('beranda/process_room_booking') ?>" method="post">
                              ...
                              <div class="lh-side-reservation-from">
                                  ...
                                  <span><strong>Rp. <?= $room->price ?></strong> / Malam</span>
                              </div>
