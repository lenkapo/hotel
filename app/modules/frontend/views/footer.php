			...
			<div class="row">
				...
				<div class="col-lg-2 col-md-6 rs-pb-24">
					<div class="lh-footer-cols-contain">
						...
						<ul class="f-list">
							<li>
								<a href="about.html">India</a>
							</li>
							<li>
								<a href="about.html">Mexico</a>
							</li>
							<li>
								<a href="about.html">Venezuela</a>
							</li>
							<li>
							...
							<li>
								<a href="about.html">swidden</a>
							</li>
							<li>
								<a href="about.html">California</a>
							</li>
						</ul>
					</div>
				</div>
		...
		<div class="modal-content v-modal-content">
			<div class="modal-body lh-video-player">
				...
				<div class="lh-player-wrapper">
					<video poster="assets/img/video/1.jpg" class="js-player" autoplay muted crossorigin
						playsinline controls>
						<source src="assets/img/video/2.mp4" />
					</video>
				</div>
			</div>
		</div>
...
<script src="<?= base_url('assets/js/vendor/semantic.min.js'); ?>"></script>
